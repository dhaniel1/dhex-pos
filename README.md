...
* [`src/dhex_pos/`](src/dhex_pos/): SPA source files (ClojureScript,
[re-frame](https://github.com/Day8/re-frame))
  - [`core.cljs`](src/dhex_pos/core.cljs): contains the SPA entry point, `init`
...
5. Clone this repo and open a terminal in the `dhex-pos` project root directory
...
The `debug?` variable in [`config.cljs`](src/cljs/dhex_pos/config.cljs) defaults to `true` in
...
```clj
(ns dhex-pos.example
  (:require [dhex-pos.config :as config])
